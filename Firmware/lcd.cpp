...
void lcd_update_enable(uint8_t enabled) {
  if (lcd_update_enabled != enabled) {
    ...
    if (enabled) { // Reset encoder position. This is equivalent to re-entering a menu.
      lcd_encoder = 0;
      lcd_encoder_diff = 0;
...
void lcd_buttons_update(void) {
  ...
  if (READ(BTN_ENC) == 0) { //button is pressed
    ...
    if (lcd_button_pressed) { //button was released
      buttonBlanking.start();
      if (lcd_long_press_active == 0) { //button released before long press gets activated
        newbutton |= EN_C;
      }
...
const uint8_t lcd_chardata_smile[8]
PROGMEM = {
        B00000,
        B11011,
        B11011,
...
const uint8_t lcd_chardata_thermometer[8]
PROGMEM = {
        B00100,
        B01010,
        B01010,
...
const uint8_t lcd_chardata_uplevel[8]
PROGMEM = {
        B00100,
        B01110,
        B11111,
...
const uint8_t lcd_chardata_refresh[8]
PROGMEM = {
        B00000,
        B00110,
        B11001,
...
const uint8_t lcd_chardata_folder[8]
PROGMEM = {
        B00000,
        B11100,
        B11111,
...
const uint8_t lcd_chardata_feedrate[8]
PROGMEM = {
        B00000,
        B00100,
        B10010,
...
const uint8_t lcd_chardata_clock[8]
PROGMEM = {
        B00000,
        B01110,
        B10011,
...
const uint8_t lcd_chardata_arrup[8]
PROGMEM = {
        B00100,
        B01110,
        B11111,
...
const uint8_t lcd_chardata_arrdown[8]
PROGMEM = {
        B00000,
        B00000,
        B00000,
...
const uint8_t lcd_chardata_progress[8]
PROGMEM = {
        B11111,
        B11111,
        B11111,
